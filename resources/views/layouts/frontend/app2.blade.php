...
<head>
  ...
  <title>SSCAKI :: KOMISI INFORMASI - PROV KEPULAUAN BANGKA BELITUNG</title>
...
<div class="wrapper">
  ...
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand text-sm fixed-top navbar-dark bg-danger">
  ...
  <footer class="main-footer">
    <strong> <a href="#">KOMINFO Provinsi Kepulauan Bangka Belitung</a>.</strong> All rights reserved.
  </footer>
  <!-- /.control-sidebar -->
</div>
<!-- ./wrapper -->
