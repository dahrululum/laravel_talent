...
<div class="">
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
        <form action="{{url('admin/post-editoperator')}}" method="POST" id="regForm">
										{{ csrf_field() }}
            <div class="card card-solid card-info">
                <div class="card-header"><b>Edit User Operator</b></div>

                <div class="card-body">
                      <div class="form-group row">
                        <label for="" class="col-sm-3 col-form-label text-info">Level User  </label>
                        <div class="col-sm-2">
                        <select class="form-control form-control-sm " name="level" id="level" onchange="getval(this);"  required>
                           
                          <option value="2" <?php if($user->level=="2"){echo"selected";}?>>Operator PD </option>
                          {{-- <option value="3" <?php if($user->level=="3"){echo"selected";}?>>Operator PD </option>
                          <option value="4" <?php if($user->level=="4"){echo"selected";}?>>Viewer </option> --}}
                        </select>
                        </div>
                    </div>
                    <div class="form-group row" >
