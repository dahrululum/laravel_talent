    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="card card-solid card-info">
                <div class="card-header"><b>Add User Operator </b></div>
                <form action="{{url('admin/post-addoperator')}}" method="POST" id="regForm" class="form-horizontal">
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-2">
                        <select class="form-control form-control-sm " name="level" id="level"  required>
                          ...
                          <option value="2">Operator PD </option>
