    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="card card-solid card-info">
                <div class="card-header"><b>Add Pelaku Ekraf</b></div>
                <form action="{{url('admin/post-addpelaku')}}" method="POST" id="regForm" class="form-horizontal" enctype="multipart/form-data">
                  <div class="card-body">
                
										{{ csrf_field() }}
                    
                    <div class="form-group row" id="idinsta">
                      <label for="inputEmail" class="col-sm-3 col-form-label">  Daerah  </label>
                      <div class="col-sm-6">
                      <select class="form-control form-control-sm select2" name="daerah" id="daerah" required>
                        <option value="">Pilih Daerah</option>
                          @foreach ($dae as $jd)  
                          <option value="{{ $jd->id }}">  {{ $jd->namadaerah }}</option>
