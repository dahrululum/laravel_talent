    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="card card-solid card-info">
                <div class="card-header"><b>Add Nilai Inovasi/Prestasi </b></div>
                <form action="{{url('admin/post-addnipotinpres')}}" method="POST" id="regForm" class="form-horizontal">
                  <div class="card-body">
					{{ csrf_field() }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control form-control-sm  " id="nip" type="number" name="nip" value=""  required />
                        </div> 
                    </div> 
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label" for="namapeg">Nama Pegawai </label>
                        <div class="col-sm-5">
                        <input class="form-control form-control-sm @error('nama') is-invalid @enderror" id="nama" type="text" name="nama" placeholder="nama pegawai" required />
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input class="form-control form-control-sm @error('nilai_inovasi') is-invalid @enderror" id="nilai_inovasi" type="number" name="nilai_inovasi" placeholder="NIlai Inovasi" step=".01"  required />
                        </div> 
                      </div>   
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label" for="inputFirstName">Nilai Prestasi</label>
                        <div class="col-sm-2">
                            <input class="form-control form-control-sm @error('nilai_prestasi') is-invalid @enderror" id="nilai_prestasi" type="number" name="nilai_prestasi" placeholder="NIlai Prestasi" step=".01" required />
                        </div> 
                      </div>    
                      <hr>
