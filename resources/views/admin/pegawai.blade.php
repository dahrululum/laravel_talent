                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a  class="btn btn-info mx-1 my-1" href="#modal_profil"  data-target="#modal_profil" data-toggle="modal" data-nip="{{$ib->nip}}" data-title="Profil Pegawai"><i class="fa fa-user"></i> Profil </a>
