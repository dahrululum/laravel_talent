    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="card card-solid card-info">
                <div class="card-header"><b>Edit MS-VAR </b></div>
                <form action="{{url('admin/post-editmsvar')}}" method="POST" id="regForm" class="form-horizontal" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input class="form-control form-control-sm  " id="idvar" type="text" name="idvar" value="{{ $ind->alias }}" readonly required />
                        </div> 
                      </div> 
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label" for="inputFirstName">Nama Variabel</label>
                        <div class="col-sm-6">
                            <input class="form-control form-control-sm @error('namavar') is-invalid @enderror" id="namavar" type="text" name="namavar" value="{{ $ind->namavar }}" required />
                        </div> 
                      </div>   
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label" for="inputFirstName">Alias Variabel</label>
                        <div class="col-sm-6">
                            <input class="form-control form-control-sm @error('namaalias') is-invalid @enderror" id="namaalias" type="text" name="namaalias" value="{{ $ind->aliasvar }}" required />
                        </div> 
                      </div>  
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <textarea class="form-control " id="definisi" name="definisi" rows="8" required> {!! $ind->definisi !!} </textarea>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <textarea class="form-control " id="refpemilihan" name="refpemilihan" rows="8" required>  {!! $ind->refpilihan !!}  </textarea>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control form-control-sm @error('refwaktu') is-invalid @enderror" id="refwaktu" type="text" name="refwaktu" value="{{ $ind->refwaktu }}" required />
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control form-control-sm @error('tipedata') is-invalid @enderror" id="tipedata" type="text" name="tipedata" value="{{ $ind->tipedata }}" required />
                        </div> 
                      </div>  
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <textarea class="form-control " id="klasifikasi" name="klasifikasi" rows="8" required>  {!! $ind->klasifikasi !!}  </textarea>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <textarea class="form-control " id="aturan" name="aturan" rows="8" required>  {!! $ind->aturan !!}  </textarea>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control " id="pertanyaan" name="pertanyaan" rows="8" required>  {!! $ind->pertanyaan !!}  </textarea>
                            <div class="  font-weight-bold text-right">Sisa Karakter : <span id="sisatanya" class="text-danger"></span></div>
                        </div> 
                      </div>
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label" for="">Dapat Diakses Umum ?</label>
                        <div class="col-sm-6">
