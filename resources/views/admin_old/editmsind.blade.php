    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="card card-solid card-info">
                <div class="card-header"><b>Edit MS-IND </b></div>
                <form action="{{url('admin/post-editmsind')}}" method="POST" id="regForm" class="form-horizontal" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input class="form-control form-control-sm @error('namaind') is-invalid @enderror" id="namaind" type="text" name="namaind" value="{{ $ind->namaind }}" required />
                        </div> 
                      </div>   
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <textarea class="form-control " id="interpretasi" name="interpretasi" rows="8" required> {!! $ind->interpretasi !!} </textarea>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <textarea class="form-control " id="rumus" name="rumus" rows="8" required> {!! $ind->rumus !!} </textarea>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                          ...
                          @if(!empty($ind->file_rumus))
                            <div class="mt-2">
                                <div>file sebelumnya:</div>
                                <div><img src="{{ asset('/uploads/'.$ind->file_rumus) }}" class="col-md-2"></div> 
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8"> 
                            <textarea class="form-control " id="ind_pembangunan_pub" name="ind_pembangunan_pub" rows="8" required> {!! $ind->ind_pembangunan_pub !!} </textarea>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <textarea class="form-control " id="ind_pembangunan_nama" name="ind_pembangunan_nama" rows="8" required> {!! $ind->ind_pembangunan_nama !!} </textarea>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <textarea class="form-control " id="var_pembangunan_nama" name="var_pembangunan_nama" rows="8" required> {!! $ind->var_pembangunan_nama !!} </textarea>
